...
|---|---|---|
| 1. Integration mode | Headless + SDK + ACP adapters exist for all three. No TUI scraping. Cursor uses first-party `agent acp`. | [claude-code.md](claude-code.md), [codex.md](codex.md), [pi.md](pi.md), [cursor.md](cursor.md) |
