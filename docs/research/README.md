...
Rust host  —  SQLite, crew, Inbox overlay, supervisor, MCP catalog
        │  ACP stdio
        ▼
claude-agent-acp / codex-acp / pi-acp / opencode acp / copilot --acp / gemini --acp / jabot --aider-acp / agent acp / custom
```
...
docs/research/
  ...
  harness-integration/
    ...
    claude-code.md  codex.md  pi.md  opencode.md  gemini.md  copilot.md  aider.md  cursor.md  buzz.md
  setup-porting/
