...
Harness from catalog (claude-agent-acp, codex-acp, pi-acp,
                      opencode acp, copilot --acp, gemini --acp, hermes acp, openclaw acp, Custom JSON, …)
...
| Tier | What | Examples |
|---|---|---|
| 1 — compiled-in | Shipped cards, auth probes, reserved ids | `claude`, `codex`, `pi`, `opencode`, `copilot`, `gemini` |
