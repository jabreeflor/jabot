 ...
 *
 * No worktree fields: a folder thread always gets a fresh worktree from the
 * host's own default base ref (#92). `thread/open` still accepts `useCheckout`
 * and `baseRef`, but the card no longer offers either. */
