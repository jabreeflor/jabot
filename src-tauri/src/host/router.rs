...
use super::protocol::methods::{
    ...
    ThreadOpenParams, ThreadReactParams, ThreadRefParams, ThreadRepoParams, ThreadSourceAddParams,
    ...
    THREAD_FOLD, THREAD_GIT_COMMIT, THREAD_GIT_DIFF, THREAD_GIT_PUSH, THREAD_OPEN, THREAD_REACT,
