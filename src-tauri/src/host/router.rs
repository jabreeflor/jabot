...
use super::protocol::methods::{
    ...
    CrewRefParams, CrewUpdateParams, FolderRefParams, FolderRegisterParams,
    ...
    CREW_DRAFTS, CREW_DRAFT_DISMISS, CREW_DRAFT_GET, CREW_DRAFT_SAVE, CREW_UPDATE, FOLDER_FORGET,
    FOLDER_LIST, FOLDER_REGISTER, FOLDER_UPDATE, GITHUB_LOGIN,
